...
public class BPI_sendform extends AppCompatActivity {
    EditText nameTxt, nameTxt2, amtTxt;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bpi_sendform);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BPI_sendform.this,Bank_selection.class);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View onClick) {
                ...
                if (sendTo.isEmpty() || amount.isEmpty() || sendName.isEmpty()) {
                    Toast.makeText(BPI_sendform.this, "Please Enter All Data", Toast.LENGTH_LONG).show();
                } else {
                    showAlertDialog();
    ...
    public void showAlertDialog() {
        ...
        alert.setPositiveButton("Proceed", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(BPI_sendform.this, "Transfer Successful!", Toast.LENGTH_LONG).show();
                showReceipt();
    ...
    public void showReceipt(){
        ...
        alert.setMessage("You Send Money to: " + nameTxt2.getText().toString()
                ...
                + nameTxt.getText().toString() + "\nAmount: "
                + amtTxt.getText().toString()
                + "\nReference Num: 237890267216");
        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent intent = new Intent(BPI_sendform.this,MainActivity.class);
                startActivity(intent);
            }
        });
        alert.create().show();
